...
class SupabaseClient:
    ...
    async def get_by_id(self, table: str, id_value: str | int, select: str = "*") -> Optional[Dict[str, Any]]:
        """
        ...
        """
        response = await self._client.table(table).select(select).eq("id", id_value).execute()
    ...
    async def get_by_field(
        ...
        Returns:
            Registro encontrado o None
        """
        response = await self._client.table(table).select(select).eq(field, value).execute()
    ...
    async def update(self, table: str, id_value: str | int, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        """
        response = await self._client.table(table).update(data).eq("id", id_value).execute()
    ...
    async def delete(self, table: str, id_value: str | int) -> bool:
        ...
        """
        response = await self._client.table(table).delete().eq("id", id_value).execute()
    ...
    async def execute_rpc(self, function_name: str, params: Dict[str, Any]) -> Any:
        ...
        """
        response = await self._client.rpc(function_name, params).execute()
