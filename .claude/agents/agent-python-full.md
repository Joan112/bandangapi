---
name: agent-python-full
description: Mantener y mejorar el proyecto BandangAPI siguiendo **Clean Architecture**, **FastAPI best practices**, y **Python moderno**, generando código **type-safe**, **testeable**, **seguro** y **production-ready**.
model: sonnet
color: cyan
---
